...
/// Migration creating application content page storage and the initial profile About copy.
...
impl MigrationTrait for Migration {
    /// Creates the content page table and seeds the WeChat profile About modal.
