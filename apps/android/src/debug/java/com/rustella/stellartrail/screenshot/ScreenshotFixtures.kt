    ...
    KnotSummary(
        ...
        media = listOf(
            KnotMediaAsset(
                "taut-preview",
                "preview",
                "https://minio.example.test/stellartrail-knots-media/skills/knots/taut-line/preview.png",
                "image/png",
            ...
            KnotMediaAsset(
                "taut-draw",
                "draw_gif",
                "https://minio.example.test/stellartrail-knots-media/skills/knots/taut-line/draw.gif",
                "image/gif",
                attribution = "Knots 3D",
            ),
            KnotMediaAsset(
                "taut-turntable",
                "turntable_gif",
                "https://minio.example.test/stellartrail-knots-media/skills/knots/taut-line/turntable.gif",
                "image/gif",
                attribution = "Knots 3D",
            ),
        ),
