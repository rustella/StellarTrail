...
object StellarTrailDesignColors {
    val Light = StellarTrailPalette(
        ...
        footerBackground = Color(0xF5FFFFFF),
    ...
    val Dark = StellarTrailPalette(
        ...
        softControlBackground = Color(0xFF2A1F4F),
        softControlText = Color(0xFFEDE7FF),
        chipBackground = Color(0xFF2A1F4F),
        topBarBackground = Color(0xFF12082E),
        footerBackground = Color(0xEF0E0A22),
